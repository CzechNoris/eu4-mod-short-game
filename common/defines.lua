...
NCountry = {
	...
	BANKRUPTCY_COLONIAL_GROWTH_PENALTY = -10, 		-- growth penalty for bankruptcy
	MAX_NATIONALISM = 10,
...
NEconomy = {
	...
	BANKRUPTCY_PROVINCE_DEVASTATION_GAIN = 3,		-- Devastation gained in country provinces after declaring bankrutcy.
